...
2. 读取 `references/crawling-guide.md`，收集资讯。优先使用用户指定信源；主动搜索综述、公众号、周报、名单型和“国内动态”文章作为线索池，抽取政策、城市、机构、项目和企业，再回溯原始来源。可用搜索引擎和网页搜索广泛发现线索，不限于政府官网；最终保留官方、监管、协会、主流媒体、公司公告、研究机构、微信公众号等可追溯来源。
